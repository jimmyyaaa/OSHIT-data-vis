                        ...
                        <>
                                ...
                                <div className="grid grid-cols-1 @sm:grid-cols-2 @xl:grid-cols-3 gap-4">
                                    {mainMetricsConfig.map((metric) => (
                                        <StatisticCard
                                            ...
                                            format={metric.title.includes("平均") || metric.title.includes("Avg") ? "decimal" : "number"}
                                        />
                                    ))}
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <Tabs defaultValue="trend" className="w-full">
                                    <TabsList>
                                        <TabsTrigger value="trend">{t.shitcode.dailyTrend}</TabsTrigger>
                                        <TabsTrigger value="topUsers">{t.shitcode.topUsers}</TabsTrigger>
                                    </TabsList>

                                    <TabsContent value="trend" className="space-y-4">
                                        <BarLineChart
                                            title={t.shitcode.dailyTrend}
                                            data={data?.dailyData ?? []}
                                            xAxisKey="date"
                                            barAxis={{
                                                dataKey: "claimCount",
