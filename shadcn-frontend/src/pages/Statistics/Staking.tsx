        ...
        <div className="w-full h-full space-y-6 p-6">
          ...
          {error ? (
            ...
            <div className="space-y-6">
              ...
              {/* 表格骨架屏 */}
              <div>
                <h2 className="text-xl font-bold mb-4">Top Stakers 详情</h2>
            ...
            <>
              ...
              <div className="w-full">
                ...
                <Tabs defaultValue="trend" className="w-full">
                  <TabsList>
                    <TabsTrigger value="trend">每日质押 vs 奖励趋势</TabsTrigger>
                    <TabsTrigger value="topStakers">质押大户分布 (Top 10)</TabsTrigger>
                  </TabsList>
