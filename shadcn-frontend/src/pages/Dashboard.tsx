      ...
      <ScrollArea className="h-full w-full">
        <div className="@container w-full space-y-8 p-6">
          ...
          {/* <div className="border-b pb-8">
            <h1 className="text-4xl font-bold">OSHIT Data Visualization</h1>
            <p className="text-muted-foreground mt-2 text-lg">实时数据监控与分析平台</p>
          </div> */}
