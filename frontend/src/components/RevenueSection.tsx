...
import { theme, getBarSeriesStyle, getLineSeriesStyle, formatDecimal, formatSOL, formatSOLNumber, getTooltipOption, getYAxisOption } from '../theme';
    ...
    return (
        <div style={{ padding: 24 }}>
            ...
            <Row gutter={[16, 16]} style={{ marginBottom: 24 }}>
                <Col xs={24} lg={8}>
                    <Card
                        title={<span style={{ color: theme.colors.text }}>Revenue Composition</span>}
                        style={theme.card}
