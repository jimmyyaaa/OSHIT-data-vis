...
import { theme, getLineSeriesStyle, getGradientBarData, getValueAxisStyle, formatNumber, formatDecimal, getTooltipOption, getYAxisOption, cardStyles } from '../theme';
import { StatisticCard } from './ui';
import type { SheetData } from '../services/dataService';
import { useAISummary } from '../hooks/useAISummary';
import { STAKING_SYSTEM_PROMPT } from '../prompts/staking';
...
const StakingSection: React.FC<StakingSectionProps> = ({
    ...
    const handleStakingAnalyze = async () => {
        if (!metrics || !dailyData || !topStakers) return;
        ...
        await handleAnalyze(context, STAKING_SYSTEM_PROMPT);
    };
